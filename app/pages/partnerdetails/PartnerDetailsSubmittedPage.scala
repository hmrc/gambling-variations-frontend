...
object PartnerDetailsSubmittedPage {
  def apply(index: Int) = new PartnerDetailsSubmittedPage(index)
  def apply(partnerDetailsBusinessNumber: String) = new PartnerDetailsSubmittedPage(partnerDetailsBusinessNumber)
}
