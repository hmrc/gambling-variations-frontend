...
object PartnerDetailsRemoveVatRegNumberYesNoPage {
  def apply(index: Int) = new PartnerDetailsRemoveVatRegNumberYesNoPage(index)
  def apply(partnerDetailsBusinessNumber: String) = new PartnerDetailsRemoveVatRegNumberYesNoPage(partnerDetailsBusinessNumber)
}
