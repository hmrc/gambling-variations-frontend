...
case class PartnerDetailsUtrPage(businessNumberOrIndex: BusinessNumberOrIndex) extends QuestionPage[String] {
  ...
  override def toString: String = "partnerDetailsUtr"
}
object PartnerDetailsUtrPage {
  def apply(index: Int) = new PartnerDetailsUtrPage(index)
  def apply(partnerDetailsBusinessNumber: String) = new PartnerDetailsUtrPage(partnerDetailsBusinessNumber)
}
