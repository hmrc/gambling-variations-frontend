...
object PartnerDetailsRemoveAdditionalInfoForPartnerAddressYesNoSummary {

  def row(answers: UserAnswers)(implicit messages: Messages): Option[SummaryListRow] = {
    val index: String = ???
    answers.get(PartnerDetailsRemoveAdditionalInfoForPartnerAddressYesNoPage(index)).map { answer =>
