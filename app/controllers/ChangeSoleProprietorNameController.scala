...
import pages.partnerdetails.PartnerDetailsSoleProprietorPage
...
class ChangeSoleProprietorNameController @Inject() (
  ...
  view: ChangeSoleProprietorNameView
  ...
  def onPageLoad(mode: Mode): Action[AnyContent] = (authorise andThen getData andThen requireData) { implicit request =>
    ...
    val preparedForm = request.userAnswers.get(PartnerDetailsSoleProprietorPage(Index)) match {
      case None        => form
