...
import pages.correspondencedetails.{CorrespondenceDetailsChangesPage, CorrespondenceEmailPage, RemoveCorrespondenceEmailAddressPage}
      ...
      .fold(
        ...
        value =>
          val updatedAnswers = for {
            ...
            cleanedAnswers <- Future.fromTry(cleanedAnswers.set(CorrespondenceDetailsChangesPage, value))
