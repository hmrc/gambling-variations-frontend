...
import controllers.actions.{AuthorisedAction, DataRetrievalAction, LicencesPremisesDataRequiredAction}
...
class CheckLicencesAndPremisesController @Inject() (
  override val messagesApi: MessagesApi,
  val controllerComponents: MessagesControllerComponents,
  authorise: AuthorisedAction,
  getData: DataRetrievalAction,
  requireData: LicencesPremisesDataRequiredAction,
  view: CheckLicenceAndPremisesView
