...
class PartnerDetailsAddDateOfJoiningPartnershipControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val partnerDetailsAddDateOfJoiningPartnershipRoute = routes.PartnerDetailsAddDateOfJoiningPartnershipController.onPageLoad(NormalMode).url
  ...
  "PartnerDetailsAddDateOfJoiningPartnership Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(PartnerDetailsAddDateOfJoiningPartnershipPage, validAnswer).success.value
