        ...
        val json = Json.obj(
          "partners" -> Json.obj(
            businessNumber1 -> Json.obj(
              PartnerDetailsMgdRegNumberPage(businessNumber1).toString -> Json.toJson(value1)
            ),
            businessNumber2 -> Json.obj(
              PartnerDetailsMgdRegNumberPage(businessNumber2).toString -> Json.toJson(value2)
            )
          )
        )

        PartnerDetailsMgdRegNumberPage(businessNumber1).path
          .asSingleJson(json)
          .validate[String]
          .get mustEqual value1

        PartnerDetailsMgdRegNumberPage(businessNumber2).path
          .asSingleJson(json)
          .validate[String]
      ...
      "be able to read and write PartnerDetailsMgdRegNumberPage values with correct index" in {
        ...
        val json = Json.obj(
          "newPartners" -> Json.arr(
            Json.obj(
              PartnerDetailsMgdRegNumberPage(newPartnersIndex1).toString -> Json.toJson(value1)
            ),
            Json.obj(
              PartnerDetailsMgdRegNumberPage(newPartnersIndex2).toString -> Json.toJson(value2)
            )
          )
        )

        PartnerDetailsMgdRegNumberPage(newPartnersIndex1).path
          .asSingleJson(json)
          .validate[String]
          .get mustEqual value1

        PartnerDetailsMgdRegNumberPage(newPartnersIndex2).path
          .asSingleJson(json)
          .validate[String]
          .get mustEqual value2
      }
