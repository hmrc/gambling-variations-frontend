...
class UnsubmittedAssociatedRegNumbersPageSpec extends AnyFreeSpec with Matchers {
  "UnsubmittedAssociatedRegNumbersPage" - {

    "must have the correct toString" in {
      UnsubmittedAssociatedRegNumbersPage.toString mustBe "unsubmittedAssociatedRegNumbers"
    }
