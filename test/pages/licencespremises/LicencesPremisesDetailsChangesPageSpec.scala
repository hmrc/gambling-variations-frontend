...
class LicencesPremisesDetailsChangesPageSpec extends PlaySpec {

  "LicencesPremisesDetailsChangesPage" must {

    "must have the correct toString" in {
      LicencesPremisesDetailsChangesPage.toString mustBe "licencesPremisesDetailsChanged"
    }
