...
class LicencesPremisesDetailsSubmittedPageSpec extends PlaySpec {

  "LicencesPremisesDetailsSubmittedPage" must {

    "must have the correct toString" in {
      LicencesPremisesDetailsSubmittedPage.toString mustBe "submitted"
    }
