...
class CorrespondenceAddressAddInfoPageSpec extends AnyFreeSpec with Matchers {

  "CorrespondenceAddressAddInfoPage" - {

    "must have the correct toString" in {
      CorrespondenceAddressAddInfoPage.toString mustBe "correspondenceAddressAddInfo"
    }
