...
class PremisesNotCoveredYesNoControllerSpec extends SpecBase with MockitoSugar {

  val formProvider = new PremisesNotCoveredYesNoFormProvider()
  ...
  "PremisesNotCoveredYesNoController Controller" - {
