...
import pages.correspondencedetails.AddEmailAddressForCorrespondenceYesNoPage
...
class AddEmailAddressForCorrespondenceYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  "AddEmailAddressForCorrespondenceYesNo Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, addEmailAddressForCorrespondenceYesNoRoute)
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(AddEmailAddressForCorrespondenceYesNoPage, true).success.value
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, addEmailAddressForCorrespondenceYesNoRoute)
