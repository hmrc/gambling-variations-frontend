...
class PartnerDetailsAdditionalAddressInfoYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  "PartnerDetailsAdditionalAddressInfoYesNo Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(PartnerDetailsAdditionalAddressInfoYesNoPage, true).success.value
    ...
    "must save the correct value to userAnswers when submitted" in {
      ...
      running(application) {
        ...
        savedAnswersCaptor.getValue.get(PartnerDetailsAdditionalAddressInfoYesNoPage).value mustEqual true
      }
    }
