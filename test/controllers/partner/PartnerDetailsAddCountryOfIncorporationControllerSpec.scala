...
class PartnerDetailsAddCountryOfIncorporationControllerSpec extends SpecBase with MockitoSugar with PartnerDetailsHelper {
  ...
  val form: Form[String] = (new PartnerDetailsAddCountryOfIncorporationFormProvider())()

  lazy val partnerDetailsAddCountryOfIncorporationRoute: String =
    controllers.partner.routes.PartnerDetailsAddCountryOfIncorporationController.onPageLoad().url
  ...
  "PartnerDetailsAddCountryOfIncorporation Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, partnerDetailsAddCountryOfIncorporationRoute)
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(PartnerDetailsCountryOfIncorporation(index), "answer").success.value
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, partnerDetailsAddCountryOfIncorporationRoute)
