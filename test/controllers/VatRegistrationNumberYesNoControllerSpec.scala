...
import forms.vat.VatRegistrationNumberYesNoFormProvider
...
import views.html.vat.VatRegistrationNumberYesNoView
...
class VatRegistrationNumberYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val vatRegistrationNumberYesNoRoute = controllers.vat.routes.VatRegistrationNumberYesNoController.onPageLoad().url

  "VatRegistrationNumberYesNo Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, vatRegistrationNumberYesNoRoute)
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(VatRegistrationNumberYesNoPage, true).success.value
