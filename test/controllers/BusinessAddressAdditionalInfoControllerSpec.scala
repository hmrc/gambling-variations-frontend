...
class BusinessAddressAdditionalInfoControllerSpec extends SpecBase with MockitoSugar {

  def onwardRoute = Call("GET", "/foo")

  val formProvider = new BusinessAddressAdditionalInfoFormProvider()
  ...
  "BusinessAddressAdditionalInfo Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, busAddRoute)
      ...
      running(application) {
        ...
        val request =
          FakeRequest(POST, busAddRoute)
            .withFormUrlEncodedBody("businessAddressAdditionalInfo" -> "jlkjfdlkjsls")
