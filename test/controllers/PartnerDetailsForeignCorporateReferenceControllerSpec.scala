...
class PartnerDetailsForeignCorporateReferenceControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val partnerDetailsForeignCorporateReferenceRoute = routes.PartnerDetailsForeignCorporateReferenceController.onPageLoad(NormalMode).url
  ...
  "PartnerDetailsForeignCorporateReference Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(PartnerDetailsForeignCorporateReferencePage, "answer").success.value
