...
class AddCorrespondingDetailsYesNoControllerSpec extends SpecBase with MockitoSugar {

  private val formProvider = new AddCorrespondingDetailsYesNoFormProvider()
  ...
  "AddCorrespondingDetailsYesNo Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, addCorrespondingDetailsYesNoRoute)
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, addCorrespondingDetailsYesNoRoute)
