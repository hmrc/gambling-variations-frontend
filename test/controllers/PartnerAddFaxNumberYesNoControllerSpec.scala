...
class PartnerAddFaxNumberYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val partnerAddFaxNumberYesNoRoute = controllers.partner.routes.PartnerAddFaxNumberYesNoController.onPageLoad().url
