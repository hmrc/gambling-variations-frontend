...
import pages.BusinessAddressNonUkPage
...
class BusinessNonUKAddressControllerSpec extends SpecBase with MockitoSugar {

  def onwardRoute: Call = Call("GET", "/foo")

  val formProvider = new BusinessNonUKAddressFormProvider()
  ...
  lazy val addressRoute: String =
    routes.BusinessNonUKAddressController.onPageLoad().url

  "BusinessNonUKAddress Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        val view = application.injector.instanceOf[BusinessNonUKAddressView]
    ...
    "must populate the view on a GET when the question has previously been answered" in {
      ...
      val userAnswers =
        noAnswers.set(BusinessAddressNonUkPage, validAddress).success.value
