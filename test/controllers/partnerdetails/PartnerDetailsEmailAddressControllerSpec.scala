...
//
//class PartnerDetailsEmailAddressControllerSpec extends SpecBase with MockitoSugar {
//
...
//    controllers.partnerdetails.routes.PartnerEmailAddressController.onPageLoad().url
//
...
//          .set(PartnerDetailsEmailAddressPage(businessNumber), "validEmail@example.com")
//          .success
//          .value
//
...
//          .get(PartnerDetailsEmailAddressPage(businessNumber))
