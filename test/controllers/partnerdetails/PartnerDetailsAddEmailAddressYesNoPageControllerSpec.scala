...
class PartnerDetailsAddEmailAddressYesNoPageControllerSpec extends SpecBase with MockitoSugar with PartnerDetailsHelper {
  ...
  lazy val partnerAddEmailAddressYesNoRoute: String =
    controllers.partnerdetails.routes.PartnerAddEmailAddressYesNoPageController.onPageLoad().url
  ...
  // TODO changed
  private val index: String = businessNumber1 // validUserAnswers.getIndex
  ...
  "PartnerAddEmailAddressYesNoPage Controller" - {
    ...
    "onPageLoad" - {
      ...
      "must populate the view correctly on a GET when the question has previously been answered" in {
        ...
        val userAnswers = validUserAnswers.set(PartnerDetailsAddEmailAddressYesNoPage(index), true).success.value
