...
class PartnerDetailsDeleteDateControllerSpec extends SpecBase with MockitoSugar with PartnerDetailsHelper {
  ...
  ): PartnerDetailsDeleteDateController =
    ...
    "must redirect to the partner details page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value mustEqual
          controllers.partnerdetails.routes.PartnerDetailsCheckConfirmRemoveDateController.onPageLoad().url
