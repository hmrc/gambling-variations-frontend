...
class PartnerDetailsContactDetailsControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val partnerContactDetailsRoute: String = controllers.partnerdetails.routes.PartnerContactDetailsController.onPageLoad().url
