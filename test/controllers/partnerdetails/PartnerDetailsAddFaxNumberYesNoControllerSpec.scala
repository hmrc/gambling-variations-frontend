...
import pages.partnerdetails.{PartnerDetailsAddFaxNumberYesNoPage, PartnerDetailsAddPartnerCompletedPage}
  ...
  "PartnerAddFaxNumberYesNo Controller" - {
    ...
    "onPageLoad" - {
      ...
      "must populate the view correctly on a GET when the question has previously been answered" in {
        ...
        val userAnswers = validUserAnswers.set(PartnerDetailsAddFaxNumberYesNoPage(index), true).success.value
