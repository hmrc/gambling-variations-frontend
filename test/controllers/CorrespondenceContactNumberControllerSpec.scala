...
import pages.correspondencedetails.{CorrespondenceContactNumberPage, CorrespondenceDetailsChangesPage}
  ...
  "CorrespondenceContact Controller" - {
    ...
    "must update data correctly when submitted in" in {
      ...
      running(application) {
        ...
        savedAnswersCaptor.getValue.get(CorrespondenceContactNumberPage).value mustEqual ContactNumber(
          Some("01632 960 001"),
          Some("07111 111 111")
        )
      }
