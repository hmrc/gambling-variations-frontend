...
class BusinessAddressAdditionalInfoRowSpec extends SpecBase {
  ...
  "BusinessAddressAdditionalInfoRow" - {
    ...
    "must render summary list row with correct data" in new Setup {
      ...
      private val ua = emptyUserAnswers
        ...
        .success
        .value
        .set(BusinessAddressAdditionalInformationPage, "This is some additional info use it wisely")
        .success
        .value
