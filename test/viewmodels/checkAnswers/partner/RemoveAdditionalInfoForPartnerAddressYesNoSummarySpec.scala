...
class RemoveAdditionalInfoForPartnerAddressYesNoSummarySpec extends SpecBase {
  ...
  "RemoveAdditionalInfoForPartnerAddressYesNoSummary" - {
    ...
    "must return None when the question has not been answered" in {
      RemoveAdditionalInfoForPartnerAddressYesNoSummary.row(emptyUserAnswers) mustBe None
    }
    ...
    "must return the correct row when the answer is Yes" in {
      ...
      RemoveAdditionalInfoForPartnerAddressYesNoSummary.row(answers).value mustBe
