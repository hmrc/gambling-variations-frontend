...
//
//class PartnerDetailsAddEmailAddressYesNoPageViewSpec extends SpecBase {
//
//  private val form = new PartnerAddEmailAddressYesNoPageFormProvider()()
//
//  "PartnerAddEmailAddressYesNoPageView" - {
//
...
//          messages(application)("partnerAddEmailAddressYesNoPage.title")
//        )
//
//        document.select("h1").select(".govuk-fieldset__heading").text() mustEqual
//          messages(application)("partnerAddEmailAddressYesNoPage.heading")
//
...
//          messages(application)("partnerAddEmailAddressYesNoPage.error.required")
//        )
//      }
//    }
//  }
