  ...
  "PartnerRemoveFaxNumberYesNoView" - {
    ...
    "render the page correctly" in {
      ...
      running(application) {
        ...
        val html = view(form, newPartnersIndex, NormalMode, faxNumber)(FakeRequest(), messages(application))
    ...
    "render an error summary when there are form errors" in {
      ...
      running(application) {
        ...
        val html = view(boundForm, newPartnersIndex, NormalMode, faxNumber)(FakeRequest(), messages(application))
