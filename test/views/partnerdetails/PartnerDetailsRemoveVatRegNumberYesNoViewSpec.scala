  ...
  "PartnerDetailsRemoveVatRegNumberYesNoView" - {
    ...
    "render the page correctly" in {
      ...
      running(application) {
        ...
        val html = view(form, newPartnersIndex, NormalMode, vatRegNumber)(FakeRequest(), messages(application))
    ...
    "render an error summary when there are form errors" in {
      ...
      running(application) {
        ...
        val html = view(boundForm, newPartnersIndex, NormalMode, vatRegNumber)(FakeRequest(), messages(application))
