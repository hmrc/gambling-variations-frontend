...
class PartnerDetailsRemoveAdditionalInfoForPartnerAddressYesNoViewSpec extends SpecBase {
  ...
  trait Setup {
    ...
    val view =
      app.injector.instanceOf[PartnerDetailsRemoveAdditionalInfoForPartnerAddressYesNoView]
  ...
  "RemoveAdditionalInfoForPartnerAddressYesNoView" - {
    ...
    "must render page correctly" in new Setup {
      ...
      val html = view(form, newPartnersIndex, NormalMode, additionalInformation)(request, messages)
    ...
    "must render error summary when form has errors" in new Setup {
      ...
      val html =
        view(boundForm, newPartnersIndex, NormalMode, additionalInformation)(request, messages)
