...
import views.html.partnerdetails.PartnerDetailsChangeSoleProprietorNameView

import scala.jdk.CollectionConverters.*

class PartnerDetailsChangeSoleProprietorNameViewSpec extends SpecBase {
  ...
  trait Setup {
    ...
    private val view = app.injector.instanceOf[PartnerDetailsChangeSoleProprietorNameView]
    ...
    private val html = view(filledForm, index, NormalMode)(request, messages)
