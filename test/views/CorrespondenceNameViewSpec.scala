...
class CorrespondenceNameViewSpec extends SpecBase {

  trait Setup {
    private val app = applicationBuilder().build()

    private val view = app.injector.instanceOf[CorrespondenceNameView]
    ...
    private val formProvider = new CorrespondenceNameFormProvider()
