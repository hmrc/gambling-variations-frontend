...
class PartnerTradingNameFormProviderSpec extends StringFieldBehaviours {

  private val requiredKey = "partnerTradingName.error.required"
  private val lengthKey = "partnerTradingName.error.length"
  private val invalidKey = "partnerTradingName.error.invalid"
    ...
    "not bind invalid characters" in {
      ...
      invalidValues.foreach { value =>
        ...
        result.errors must contain(
          FormError(fieldName, invalidKey, Seq(partnerNameRegex))
        )
      }
    }
  }
