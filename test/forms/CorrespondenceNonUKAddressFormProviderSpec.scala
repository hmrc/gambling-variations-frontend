...
class CorrespondenceNonUKAddressFormProviderSpec extends StringFieldBehaviours {
  ...
  private val requiredKey = "correspondenceNonUKAddress.error.required"
  private val lengthKey = "correspondenceNonUKAddress.error.length"
  private val invalidKey = "correspondenceNonUKAddress.error.invalid"

  private val maxLength = 100

  private val form = new CorrespondenceNonUKAddressFormProvider()()

  private val correspondenceNonUKAddressRegex = "^[a-zA-Z0-9\\-'\\s]+$"

  ".correspondenceNonUKAddress" - {

    val fieldName = "correspondenceNonUKAddress"
    ...
    "not bind invalid characters" in {
      ...
      invalidValues.foreach { value =>
        ...
        result.errors must contain(
          FormError(fieldName, invalidKey, Seq(correspondenceNonUKAddressRegex))
        )
      }
    }
  }
