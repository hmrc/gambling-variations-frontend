...
class PartnerDetailsAdditionalInfoFormProviderSpec extends StringFieldBehaviours {
  ...
  private val invalidKey = "partnerDetailsAdditionalAddressInfo.error.invalid"

  private val maxLength = 100

  private val form = new PartnerDetailsAdditionalAddressInfoFormProvider()()

  private val partnerDetailsAdditionalInfoRegex = "^[a-zA-Z0-9\\-'\\s]+$"

  ".partnerDetailsAddressAdditionalInfo" - {

    val fieldName = "partnerDetailsAdditionalAddressInfo"
    ...
    "not bind invalid characters" in {
      ...
      invalidValues.foreach { value =>
        ...
        result.errors must contain(
          FormError(fieldName, invalidKey, Seq(partnerDetailsAdditionalInfoRegex))
        )
      }
    }
  }
