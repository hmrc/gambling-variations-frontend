...
class BusinessUKAddressFormProviderSpec extends StringFieldBehaviours {

  private val form = new BusinessUKAddressFormProvider()()
  ...
  ".addressLine1" - {
    ...
    val requiredKey = "businessUKAddress.addressLine1.error.required"
    val lengthKey = "businessUKAddress.addressLine1.error.length"
    val invalidKey = "businessUKAddress.addressLine1.error.invalid"
    val maxLength = 27
  ...
  ".addressLine2" - {
    ...
    val requiredKey = "businessUKAddress.addressLine2.error.required"
    val lengthKey = "businessUKAddress.addressLine2.error.length"
    val invalidKey = "businessUKAddress.addressLine2.error.invalid"
    val maxLength = 27
  ...
  ".townOrCity" - {
    ...
    val requiredKey = "businessUKAddress.townOrCity.error.required"
    val lengthKey = "businessUKAddress.townOrCity.error.length"
    val invalidKey = "businessUKAddress.townOrCity.error.invalid"
    val maxLength = 27
  ...
  ".county" - {
    ...
    val lengthKey = "businessUKAddress.County.error.length"
    val invalidKey = "businessUKAddress.County.error.invalid"
    val maxLength = 18
  ...
  ".postcode" - {
    ...
    val requiredKey = "businessUKAddress.Postcode.error.required"
    val invalidKey = "businessUKAddress.Postcode.error.invalid"
    val formatKey = "businessUKAddress.Postcode.error.format"
    val lengthKey = "businessUKAddress.Postcode.error.length"
    val maxLength = 8
